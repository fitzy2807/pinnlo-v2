...
class ElevenLabsClient {
  ...
  async speechToText(request: SpeechToTextRequest): Promise<{ text: string; language?: string }> {
...
// Tool handlers
export async function handleGetElevenLabsVoices(args: any) {
...
export async function handleGetElevenLabsVoice(args: any) {
  const apiKey = process.env.ELEVENLABS_API_KEY;
  if (!apiKey) {
    throw new Error('ELEVENLABS_API_KEY environment variable is required');
  }
...
export async function handleElevenLabsTextToSpeech(args: any) {
  const apiKey = process.env.ELEVENLABS_API_KEY;
  if (!apiKey) {
    throw new Error('ELEVENLABS_API_KEY environment variable is required');
  }
...
export async function handleElevenLabsSpeechToText(args: any) {
  const apiKey = process.env.ELEVENLABS_API_KEY;
  if (!apiKey) {
    throw new Error('ELEVENLABS_API_KEY environment variable is required');
  }
...
export async function handleGetElevenLabsModels(args: any) {
  const apiKey = process.env.ELEVENLABS_API_KEY;
  if (!apiKey) {
    throw new Error('ELEVENLABS_API_KEY environment variable is required');
  }
...
export async function handleGetElevenLabsUser(args: any) {
  const apiKey = process.env.ELEVENLABS_API_KEY;
  if (!apiKey) {
    throw new Error('ELEVENLABS_API_KEY environment variable is required');
  }
...
export async function handleGetElevenLabsSubscription(args: any) {
  const apiKey = process.env.ELEVENLABS_API_KEY;
  if (!apiKey) {
    throw new Error('ELEVENLABS_API_KEY environment variable is required');
  }
