...
export async function handleExecuteCommand(args) {
    try {
        const { command, cwd = '/Users/matthewfitzpatrick/pinnlo-v2', timeout = 30000 } = args;
        // Security check
...
export async function handleReadFileContent(args) {
    try {
        const { filepath, encoding = 'utf-8', maxSize = 1024 * 1024 // 1MB default
         } = args;
        // Path safety check
...
export async function handleListDirectoryContents(args) {
    try {
...
export async function handleGetProjectStatus(args) {
    try {
...
export async function handleMonitorFileChanges(args) {
    try {
