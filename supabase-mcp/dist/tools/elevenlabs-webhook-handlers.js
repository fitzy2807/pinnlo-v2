...
export class ElevenLabsWebhookHandler {
    ...
    async handleProcessVoiceIntelligence(params) {
        try {
    ...
    async handleGenerateStrategyCards(params) {
        try {
    ...
    async handleGenerateTechnicalRequirement(params) {
        try {
    ...
    async processTextToIntelligence(text, context) {
    ...
    async generateStrategyCardsFromPrompt(prompt, context) {
    ...
    async generateTechnicalRequirementFromFeatures(features, strategyContext) {
    ...
    async analyzeUrlContent(url, analysisType) {
...
export function setupElevenLabsWebhookRoutes(app, supabase) {
    const handler = new ElevenLabsWebhookHandler(supabase);
    // Webhook endpoint for voice intelligence processing
    app.post('/api/tools/process_voice_intelligence', async (req, res) => {
        try {
    ...
    app.post('/api/tools/generate_strategy_cards', async (req, res) => {
        try {
    ...
    app.post('/api/tools/generate_technical_requirement', async (req, res) => {
        try {
    ...
    app.post('/api/tools/analyze_url', async (req, res) => {
        try {
...
//# sourceMappingURL=elevenlabs-webhook-handlers.js.map