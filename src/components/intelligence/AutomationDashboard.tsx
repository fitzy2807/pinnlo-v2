 ...
 * 
 * Manages automation rules for generating intelligence cards on schedule
 */
...
export default function AutomationDashboard() {
  ...
  const handleExecuteRule = async (ruleId: string) => {
    ...
    if (result.success) {
      alert(`Successfully generated ${result.cardsCreated || 0} intelligence cards`)
    } else {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Intelligence Automation</h2>
        <p className="text-sm text-gray-600">Automatically generate intelligence cards on schedule</p>
      </div>
