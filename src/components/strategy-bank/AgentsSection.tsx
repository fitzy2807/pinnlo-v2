...
export default function AgentsSection({ strategy, selectedAgentId, onClose, onCardsCreated }: AgentsSectionProps) {
  ...
  // Get agents assigned to Strategy Hub
  const agents = getAgentsForHub('strategy')
  ...
  return (
    <div className="h-full bg-gray-50">
      <div className="p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-2">Strategy Agents</h2>
        <p className="text-sm text-gray-600 mb-6">
          Select an agent to help create and manage strategy content
        </p>
        ...
        {agents.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">
              No agents are currently assigned to the Strategy Hub.
            </p>
