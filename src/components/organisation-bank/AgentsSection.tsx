...
import { Bot, FileText, Building2, Users } from 'lucide-react'
...
export default function AgentsSection({ selectedAgentId, onClose, onCardsCreated }: AgentsSectionProps) {
  ...
  // Get agents assigned to Organisation Hub
  const agents = getAgentsForHub('organisation')
  ...
  return (
    <div className="h-full bg-gray-50">
      <div className="p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-2">Organisation Agents</h2>
        <p className="text-sm text-gray-600 mb-6">
          Select an agent to help manage organisational structure and processes
        </p>
        ...
        {agents.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">
              No agents are currently assigned to the Organisation Hub.
            </p>
