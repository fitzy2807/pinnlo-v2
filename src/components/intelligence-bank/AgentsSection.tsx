...
import { Bot, Link, FileText, Zap } from 'lucide-react'
...
export default function AgentsSection({ selectedAgentId, onClose, onCardsCreated }: AgentsSectionProps) {
  ...
  const agents = getAgentsForHub('intelligence')
  ...
  return (
    <div className="h-full bg-gray-50">
      <div className="p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-2">Intelligence Agents</h2>
        <p className="text-sm text-gray-600 mb-6">
          Select an agent to extract and process intelligence from various sources
        </p>
        ...
        {agents.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">
              No agents are currently assigned to the Intelligence Hub.
            </p>
