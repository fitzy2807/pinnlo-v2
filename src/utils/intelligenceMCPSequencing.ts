...
import { INTELLIGENCE_BLUEPRINT_DEPENDENCIES, BLUEPRINT_KEYS, normalizeBlueprintKey } from './blueprintConstants'
...
export class IntelligenceMCPSequencer {
   ...
   * Using registry-based constants to ensure consistency
   */
  private readonly INTELLIGENCE_BLUEPRINT_MAPPING = INTELLIGENCE_BLUEPRINT_DEPENDENCIES
