          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4 max-h-[80vh] overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-teal-500 to-blue-600 text-white p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold">Voice Intelligence Assistant</h2>
            ...
            <div className="p-6 bg-gray-50 min-h-[400px] flex flex-col">
              ...
              <div className="mt-6 bg-blue-50 rounded-lg p-4">
                <h3 className="text-sm font-medium text-blue-800 mb-2">Voice Commands Available:</h3>
                <div className="grid grid-cols-2 gap-2 text-xs text-blue-700">
                  <div>• "Turn this into a feature card"</div>
                  <div>• "Create a strategy card"</div>
                  <div>• "Analyze this URL"</div>
                  <div>• "Generate intelligence card"</div>
                </div>
              </div>
            </div>
          </div>
